...
const ProposalBanner = () => {
    return (
        <section className="w-full bg-[#1F0A0F] relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 lg:px-12 relative z-10">
                <div className="flex flex-col md:flex-row items-center justify-between py-12 md:py-16 gap-8">
                    ...
                    <div className="w-full md:w-1/2 relative group">
                        <div className="relative rounded-2xl overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.5)] border border-[#722F37]/30">
                            <img
                                src={bannerImg}
                                alt="Proposal Ring"
                            ...
                            />
                            {/* Inner Glow */}
                            <div className="absolute inset-0 bg-gradient-to-tr from-[#2F0A0F]/60 to-transparent pointer-events-none"></div>
                        </div>
                        {/* Decorative Circle */}
                    ...
                    <div className="w-full md:w-1/2 text-center md:text-left space-y-6">
                        ...
                        <div className="pt-4">
                            <Link
                                to="/category/rings"
                                className="inline-flex items-center gap-3 bg-white text-[#2F0A0F] px-8 py-4 rounded-full font-medium hover:bg-[#F0F0F0] transition-all transform hover:-translate-y-1 shadow-[0_10px_20px_rgba(0,0,0,0.2)] group"
                            >
